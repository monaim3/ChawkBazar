...
type ProductData = {
  ...
  prices?: {
    color: string;
    sizes: { size_id: string; size: string; price: number }[];
  }[];
};
...
const ProductGalleryComponent: React.FC<ProductGalleryProps> = ({
  gallery,
  mainImage,
}) => {
      ...
      <div className="col-span-4 pt-8 lg:pt-0">
        <div className="pb-7 mb-7 border-b border-gray-300">
          ...
          <div className="flex items-center mt-5">
            <div className="text-heading font-bold text-base md:text-xl lg:text-2xl 2xl:text-4xl ltr:pr-2 rtl:pl-2">
              {price}
            </div>
            {discount && (
        ...
        <div className="flex items-center gap-x-4 border-b border-gray-300 py-8">
          <Counter
            quantity={quantity}
